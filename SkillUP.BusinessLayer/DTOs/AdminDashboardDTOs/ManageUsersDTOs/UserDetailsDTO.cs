...
namespace SkillUP.BusinessLayer.DTOs.AdminDashboardDTOs.ManageUsersDTOs
{
    public class UserDetailsDTO
    {
        ...
        public static explicit operator GeneralUser(UserDetailsDTO dto)
        {
        ...
        public static explicit operator Instructor(UserDetailsDTO dto)
        {
        ...
        // Mapping function
        public static UserDetailsDTO FromUser(GeneralUser user)
        {
